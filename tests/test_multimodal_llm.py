...
def test_multimodal_llm_instantiation():
    ...
    try:
        ...
        with patch("openai.AsyncClient"):
            llm_instance = MultimodalLLM(model="gpt-4o-audio-preview", enable_multimodal=True)
...
def test_multimodal_llm_disable_flag():
    ...
    try:
        ...
        with patch("openai.AsyncClient"):
            llm_instance = MultimodalLLM(model="gpt-4o-audio-preview", enable_multimodal=False)
    ...
    try:
        ...
        with patch("openai.AsyncClient"):
            ...
            with patch.object(llm_instance.__class__.__bases__[0], "chat") as mock_chat:
                ...
                result = llm_instance.chat(chat_ctx=chat_ctx, audio_data=b"fake_audio_data")
